...
function WorkData(){
    ...
    return(
        ...
        <div id="work" className="workdata">
            ...
            <WorkCard link="https://www.behance.net/gallery/189306259/Case-Study-The-Next-gen-payment-method-landing-page" hoverEffect="hovereffect" text="Case Study" url={nextrio} head3="Nextrio" paratop="[Study Based Innovations]" paradown="Revolutionize your payment experience with our Next Gen Payment Method Landing Page. Seamlessly blending innovation and convenience, we're shaping the future of digital transactions." />
            <WorkCard link="https://www.behance.net/gallery/189442577/Case-Study-Inventory-management-dashboard-design" hoverEffect="hovereffect" text="Case Study" url={inv} head3="INV Dashboard " paratop="[Study Based Innovations]" paradown="Efficiently manage inventory, suppliers, orders, and generate insightful reports with our comprehensive Inventory Management System." />
            <WorkCard link="https://www.behance.net/gallery/189443037/Case-Study-B2B-E-commerce-website" hoverEffect="hovereffect" text="Case Study" url={b2b} head3="B2B E-commerce Website " paratop="[Study Based Innovations]" paradown="Elevate B2B transactions with our meticulously crafted ecommerce website design, tailored for seamless business-to-business interactions." />
            <WorkCard link="https://www.behance.net/gallery/191041807/Re-designed-Login-page-for-IRCTC-Rail-Connect-App" hoverEffect="hovereffect" text="Case Study" url={irctc} head3="IRCTC Rail Connect Login Page " paratop="[Study Based Innovations]" paradown="Revolutionized the IRCTC Rail Connect app login page with a contemporary redesign, enhancing user experience and functionality." />
            <WorkCard  text="Unavailable" url={goodluck} head3="Good Luck" paratop="[Study Based Innovations]" paradown="Your’s ultimate giveaway companion app where users can effortlessly create, join, and select winners for exciting giveaways." />
