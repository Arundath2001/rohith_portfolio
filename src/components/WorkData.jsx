...
function WorkData(){
    ...
    return(
        ...
        <div id="work" className="workdata">
            ...
            <WorkCard  text="Inprogress" video={goodluckv} url={goodluck} head3="Good Luck" paratop="[Freelance Project]" paradown="Your’s ultimate giveaway companion app where users can effortlessly create, join, and select winners for exciting giveaways." />
